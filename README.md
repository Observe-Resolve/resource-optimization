...
## Episode : Resource Optimization using the new smartscape
...
<p align="center"><img src="/image/Smartscape_horizontal.png" width="40%" alt="Logs IG" /></p>
...
```shell
git clone  https://github.com/Observe&Resolve/resource-optimization
...
Let's deploy the workflow located : `dynatrace/dynatrace/smart-k8s-resource-optimizer.workflow-template.yaml`
